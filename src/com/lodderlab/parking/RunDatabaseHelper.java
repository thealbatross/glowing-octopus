...
public class RunDatabaseHelper extends SQLiteOpenHelper {
    ...
    public static class LocationCursor extends CursorWrapper{
    	...
    	public Location getLocation(){
    		if (isBeforeFirst() || isAfterLast())
    			return null;
    		// get the provider so that you can use the constructor
    ...
    public void onCreate(SQLiteDatabase db){
        ...
        db.execSQL("create table location (" +"_id timestamp integer, latitude real, longitutde real, altitude real,"+" provider varchar(100), run_id integer references run(_id))");
    }
